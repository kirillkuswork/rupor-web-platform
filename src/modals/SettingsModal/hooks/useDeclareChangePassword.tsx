...
import { IChangeDeclareRequest } from '@/redux/services/users/requestModel';
import { useLazyUserChangeDeclareQuery } from '@/redux/services/users';

export const useDeclareChangePassword = (params: IChangeDeclareRequest) => {
  const [declare, { isFetching }] = useLazyUserChangeDeclareQuery();
